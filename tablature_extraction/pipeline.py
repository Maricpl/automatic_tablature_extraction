...
class TablatureGenerationPipeline:
    def __init__(self, separation_model: str, transcription_model: str, output_dir: str = None):
        if output_dir is None:
            time_str = datetime.now().strftime("%Y-%m-%d_%H-%M-%S")
            output_dir = os.path.join("data/results", time_str)
...
if __name__ == "__main__":
    ...
    guitar_stem, midi_data = pipeline.inference(args.audio)
    print("Guitar stem saved at:", guitar_stem)
    print("MIDI data saved at:", midi_data)
