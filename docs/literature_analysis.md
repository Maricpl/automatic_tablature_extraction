...
| **Wave-U-Net** | Wave-U-Net: A Multi-Scale Neural Network for End-to-End Audio Source Separation | 2018 | **Stoller et al.** <br> Time-domain adaptation of U-Net; avoids STFT issues. |
...
| **Demucs** | Music Source Separation in the Waveform Domain | 2019 | **Défossez et al.** <br> Waveform-to-waveform U-Net with GLUs; strong bass/drums performance. |
| **Conv-TasNet** | Conv-TasNet: Surpassing Ideal Time-Frequency Magnitude Masking for Speech Separation | 2019 | **Luo & Mesgarani** <br> Time-domain dilated convolutional network; originally for speech, adapted for music. |
| **Spleeter** | Spleeter: a fast and efficient music source separation tool with pre-trained models | 2020 | **Hennequin et al.** <br> Deezer's industrial tool; efficient U-Net based TensorFlow implementation. |
...
| **KUIELab-MDX-Net** | KUIELab-MDX-Net: A Two-Stream Neural Network for Music Demixing | 2021 | **Kim et al.** <br> Winning solution for MDX 2021; ensemble of TFC-TDF-U-Net and Demucs. |
| **TFC-TDF-U-Net** | KUIELab-MDX-Net (TFC-TDF-U-Net) | 2021 | **Choi et al.** <br> Time-Frequency Convolutions and Time-Distributed Fully-connected U-Net. |
| **Unified Zero-Shot Model** | A unified model for zero-shot music source separation, transcription and synthesis | 2021 | **Lin et al.** <br> Explores zero-shot separation using pitch information. |
...
| **Band-split RNN** | Music Source Separation with Band-split RNN | 2023 | **Luo & Yu** <br> Splits spectrogram into subbands processed by RNNs for fine-grained modeling. |
...
| **A Stem-Agnostic System** | A Stem-Agnostic Single-Decoder System for Music Source Separation Beyond Four Stems | 2024 | **Watcharasupat & Lerch** <br> Single decoder architecture for arbitrary stem separation. |
...
| **Onsets and Frames** | Onsets and Frames: Dual-Objective Piano Transcription | 2018 | **Hawthorne et al.** <br> Standard model for piano; uses separate heads for onsets and frames. |
...
| **ASAP** | ASAP: a dataset of aligned scores and performances for piano transcription | 2020 | **Foscarin et al.** <br> Large dataset of aligned piano scores and performances. |
